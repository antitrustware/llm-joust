...
CRITERIA_PRESETS: dict[str, dict] = {
    ...
    "finance": {
        ...
        "criteria": "financial accuracy, soundness of assumptions, analytical rigor, practical applicability, and awareness of risks and edge cases",
        "keywords": [
            "valuation", "dcf", "discounted cash flow", "ebitda", "revenue",
            "margin", "irr", "npv", "roi", "cap table", "dilution", "waterfall",
            "m&a", "merger", "acquisition", "diligence", "due diligence", "loi",
            "term sheet", "deal structure", "earnout", "synergies", "accretion",
            "lbo", "leveraged buyout", "debt", "leverage", "covenant",
            "private equity", "venture capital", "growth equity", "fund",
            "portfolio company", "exit", "ipo", "secondary", "carry",
            "corporate development", "corp dev", "strategic", "strategy",
            "market entry", "competitive advantage", "moat", "tam", "sam", "som",
            "financial model", "three statement", "balance sheet", "income statement",
            "cash flow", "working capital", "capex", "opex", "burn rate", "runway",
            "gaap", "non-gaap", "accounting", "audit", "consolidation",
            "comparable", "comps", "multiples", "enterprise value", "equity value",
            "pitch deck", "investor", "fundraise", "series a", "series b",
            "board", "fiduciary", "shareholder", "dividend", "buyback",
            "funding round", "pre-money", "post-money", "arpu", "ltv", "cac",
        ],
    },
    "general": {
